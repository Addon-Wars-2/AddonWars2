...
namespace AddonWars2.App.Helpers
{
    ...
    {
        // TODO: There is the inconsistency between reading (deserialize) and writing (serialize) approaches.
        //       Serializer returns string, but doesn't wtire anything to a file. We use WriteXml(...) methods for that.
        //       While Deserializer does two jobs: it reads a file and then deserializes it. Single responsibility?
